...
module.exports = {
  ...
  theme: {
    extend: {
       ...
       * tight=4, snug=8, normal=12, relaxed=16, loose=24, spacious=32, airy=48
       * ======================================== */
      spacing: {
        'tight': '4px',
        'snug': '8px',
      ...
      fontFamily: {
        /* IBM Plex Sans：自托管于 src/renderer/assets/fonts（见 globals.css 的 @font-face）。
           Latin 子集承担西文/数字，CJK 由系统中文族回退，故不引入中文字体文件。
           此栈必须与 globals.css `body` 的 font-family 保持一致。 */
        sans: ['IBM Plex Sans', 'system-ui', '-apple-system', 'Segoe UI', 'PingFang SC', 'Microsoft YaHei UI', 'Microsoft YaHei', 'Noto Sans SC', 'sans-serif'],
