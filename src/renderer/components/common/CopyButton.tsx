...
export function CopyButton({ name, size = 'md' }: CopyButtonProps) {
  ...
  return (
    <span
      ...
      className="p-0.5 rounded text-[var(--text-muted)] hover:[color:var(--brand-primary)] hover:bg-[color-mix(in_srgb,var(--brand-primary)_10%,transparent)] transition-all flex-shrink-0 cursor-pointer"
