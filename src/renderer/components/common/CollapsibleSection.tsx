  ...
  return (
    <div className={`mb-[var(--space-relaxed)] ${className}`}>
      <button
        ...
        className={`flex items-center gap-[var(--space-snug)] text-xs text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand-primary)]/20 ${buttonClassName}`}
