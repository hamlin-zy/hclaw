...
> 抖音介绍视频搜索：hamlin_zy
>
> [B站介绍视频](https://www.bilibili.com/video/BV1yUEh61Ee5/)
...
快速安装，直接新建对话，让HClaw帮您安装：
```angular2html
请帮我安装node.js、python、git，并将 npm、npx、pip 仓库地址修改为国内镜像仓库
```

> 原因：当前mcp生态依赖node、python本地运行环境，缺少这两个，mcp服务可能服务运行 
> 
> 注意：安装过程中，可能会因为网络等原因失败，通过和HClaw对话，HClaw可以自行解决。
