...
describe('ConversationSidebar footer / 折叠态', () => {
    ...
    it('折叠态渲染全部菜单项（与齿轮菜单同源 21 项）+ 展开按钮', () => {
        ...
        expect(collapsedLabels).toEqual([
            '模型方案', '服务商', 'Agents', 'Skills', '命令', '插件', '内置工具', 'MCP 服务', '跟随启动', '权限配置', 'IM 渠道',
