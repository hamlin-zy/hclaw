...
describe('configWindow 注册表', () => {
    it('白名单含 25 种 dialogType', () => {
        expect(CONFIG_DIALOG_TYPES.size).toBe(25)
        expect(CONFIG_DIALOG_TYPES.has('companion-apps')).toBe(true)
        expect(CONFIG_DIALOG_TYPES.has('memory-manager')).toBe(true)
